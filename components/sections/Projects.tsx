        ...
        {PROJECTS.map((project, i) => {
          ...
          >
            ...
            <div className="flex flex-1 flex-col gap-4 p-6">
              <h3 className="font-heading text-lg font-semibold text-slate-800 dark:text-zinc-100 leading-snug">
                {item.title}
              </h3>
              ...
              <ul className="flex flex-wrap gap-2">
                {item.features.map((f) => (
                  <li
                    key={f}
                    className="rounded-md bg-slate-200/80 border border-slate-300/60 px-2.5 py-1 text-xs text-slate-700
